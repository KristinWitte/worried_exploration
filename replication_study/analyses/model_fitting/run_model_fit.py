...
if __name__ == "__main__":
    ...
    N_BLOCKS = len(data.loc[data["ID"] == 1, "block"].unique())
    ...
    cond[~missing[:,0]] = data.loc[data["trial"] == 1, "krakenPresent"]
    ...
    # Save results
    output_dir = "~/replication_study/model_fitting/results/model_fitting/{0}_{1}".format(decision_model.lower(), dat)
